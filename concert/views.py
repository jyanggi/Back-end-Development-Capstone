...
def songs(request):
    url = 'http://songs-sn-labs-johnguaz.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud'
    songs = req.get(f"{url}/song").json()
    return render(request, "songs.html", {"songs":songs["songs"]})


def photos(request):
    photos = req.get("https://pictures.1ufkkv6fmvas.us-south.codeengine.appdomain.cloud/picture").json()
